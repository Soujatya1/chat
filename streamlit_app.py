...
template = """
You are an assistant for question-answering tasks. Use the following pieces of retrieved context to answer the question. If you don't know the answer, just say that you don't know. As per the question asked, please mention the related information in full and use point-wise format wherever necessary.
Question: {question} 
Context: {context} 
Answer:
"""
